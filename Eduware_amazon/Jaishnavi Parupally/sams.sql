...
INSERT INTO `attendance` (`att_id`, `date`, `s_enrl`, `usub_id`, `present`) VALUES
...
--
-- Table structure for table `attendance0`
--

CREATE TABLE `attendance0` (
  `att_id` int(11) NOT NULL,
  `date` date NOT NULL,
  `s_enrl` int(7) NOT NULL,
  `usub_id` int(4) NOT NULL,
...
--
-- Indexes for table `attendance0`
--
ALTER TABLE `attendance0`
  ADD PRIMARY KEY (`att_id`),
  ADD KEY `date` (`date`),
  ADD KEY `s_enrl` (`s_enrl`),
  ADD KEY `usub_id` (`usub_id`),
...
ALTER TABLE `attendance_mba_sem9`
  MODIFY `att_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `attendance0`
--
ALTER TABLE `attendance0`
  MODIFY `att_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `attendance_ibfk_1` FOREIGN KEY (`date`) REFERENCES `days` (`date`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `attendance_ibfk_2` FOREIGN KEY (`s_enrl`) REFERENCES `student` (`s_enrl`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `attendance_ibfk_3` FOREIGN KEY (`usub_id`) REFERENCES `subject` (`usub_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `attendance0`
--
ALTER TABLE `attendance0`
  ADD CONSTRAINT `attendance0_ibfk_1` FOREIGN KEY (`date`) REFERENCES `days` (`date`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `attendance0_ibfk_2` FOREIGN KEY (`s_enrl`) REFERENCES `student` (`s_enrl`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `attendance0_ibfk_3` FOREIGN KEY (`usub_id`) REFERENCES `subject` (`usub_id`) ON DELETE CASCADE ON UPDATE CASCADE;
