 ...
 <?php
  ...
  ?>
        ...
        <thead style="color:white;background:#202020;">
                       ...
                       <th align="center" width="42%">Responded :</th>
                       <th align="center" width="12%">Responded on :</th>
                       </font>
         </thead>
    <?php
    $cnt=0;
     foreach((array)$student_notifications as $s_noti)
     {

         if($s_noti->to_type=="to_admin" && $s_noti->respond_message!=NULL){
