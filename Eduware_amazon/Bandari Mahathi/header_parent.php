                ...
                <ul class="nav" id="main-menu1">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse    closer9"  >
                            ...
                            <li>
                                <a href="view_notifications_parent.php">School</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a  href="#" class ='trigger'><i class="fa fa-pencil-square-o fa-2x"></i> Query Reporting<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse     closer9" >
                            <li>
                                <a href="add_query.php">Send</a>
                            </li>
                            <li>
                                <a href="view_query_parent.php">Sent</a>
                            </li>
                        </ul>
                    </li>
                    <li>
