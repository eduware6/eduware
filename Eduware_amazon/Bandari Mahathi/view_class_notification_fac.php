...
function getNotifications(user_type)
{
 ...
 <?php
  ...
  ?>
        ...
        $student_notifications=$md->sel_where($con,"class_notifications", $where);
        ...
        <thead style="color:white;background:#202020;">
                       ...
                       <th align="center" width="15%">Sent On :</th>
                       </font>
         </thead>
    <?php
    $cnt=0;
     foreach($student_notifications as $s_noti)
     {
         if($s_noti->to_type){
            ...
            $newcreatedDate = date("d-m-Y", strtotime($createdDate));
                ...
                <tr align="center">
                   <td><?php echo $cnt; ?></td>
                   <td><?php echo $s_noti->class; ?> </td>
                   <td><?php echo $s_noti->section; ?> </td>
                   <td align="left"><?php echo $s_noti->message; ?></td>
                   <td><?php echo $s_noti->created_on;?></td>
                 </tr> 
                 <?php
                   }}
                   ?>
